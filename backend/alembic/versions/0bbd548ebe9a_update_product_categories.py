...
Revision ID: 0bbd548ebe9a
Revises: 2a875440a749
Create Date: 2025-09-06 08:25:16.055868
...
revision: str = '0bbd548ebe9a'
down_revision: Union[str, Sequence[str], None] = '2a875440a749'
...
def downgrade() -> None:
    ...
    sa.Column('role', sa.VARCHAR(length=11), nullable=True),
    ...
    sa.Column('category', sa.VARCHAR(length=28), nullable=False),
    ...
    sa.Column('name', sa.VARCHAR(), nullable=False),
    sa.Column('description', sa.TEXT(), nullable=True),
    sa.Column('category', sa.VARCHAR(length=7), nullable=False),
    ...
    sa.Column('audit_status', sa.VARCHAR(length=8), nullable=True),
    ...
    sa.Column('payment_method', sa.VARCHAR(length=16), nullable=True),
