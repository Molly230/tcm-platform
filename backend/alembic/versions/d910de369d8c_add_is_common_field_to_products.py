"""add is_common field to products

Revision ID: d910de369d8c
Revises: d6776bae9ccb
Create Date: 2025-09-04 20:28:45.505001
...
revision: str = 'd910de369d8c'
down_revision: Union[str, Sequence[str], None] = 'd6776bae9ccb'
...
def downgrade() -> None:
    ...
    sa.Column('category', sa.VARCHAR(length=17), nullable=False),
