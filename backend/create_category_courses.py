...
def create_category_courses():
    """创建分类课程数据"""
    db = SessionLocal()
    
    try:
        # 1. 逐病精讲 - 失眠专题
        insomnia_course = models.Course(
            title="逐病精讲：失眠调理专题",
        ...
        for lesson_data in insomnia_lessons:
            lesson = models.Lesson(
                ...
                **lesson_data,
                video_id=f"insomnia_lesson_{lesson_data['order']}",
        ...
        for lesson_data in gastric_lessons:
            lesson = models.Lesson(
                ...
                **lesson_data,
                video_id=f"gastric_lesson_{lesson_data['order']}",
        ...
        # 3. 全面学医系列课程
        comprehensive_course = models.Course(
            title="全面学医：中医入门到精通",
            ...
            instructor="张仲景传人",
            total_lessons=12,
            total_duration=18000  # 50课时×36分钟
        )
        ...
        for lesson_data in comprehensive_lessons:
            lesson = models.Lesson(
                ...
                **lesson_data,
                video_id=f"comprehensive_lesson_{lesson_data['order']}",
